   ...
   if($withdraw_address) {
      if($withdraw_amount) {
         ...
         if($withdraw_amount<=$Chncoind_Balance) {
            ...
            $Chncoind_Withdraw_From = $Chncoind->sendtoaddress($withdraw_address,(float)$true_withdraw_amount);
            if($Chncoind_Withdraw_From) {
               $result = minusfunds($user_session,"LTC",$withdraw_amount);
               $result = plusfunds($FEEBEE,"LTC","0.01");            // add fee to feebee account
      ...
      $withdraw_message = 'No Litecoin address was entered!';
   }
}
?>
<html>
         ...
         <td align="center" valign="top" style="padding: 5px;" nowrap>
            <table>
               <tr>
                  ...
                  <td align="center" style="padding: 2px; font-weight: bold; color: #666666;" nowrap><?php echo $Chncoind_Account_Address; ?></td>
               <tr><tr>
                  <td align="left" style="padding: 2px; padding-left: 20px;">Deposits must have 6 confirmations to become active. There is a fee of 0.01 Litecoin to make a withraw.</td>
               </tr>
            </table>
            </center>
         </td>
