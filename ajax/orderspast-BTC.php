<?php
error_reporting(0);
$sql = "SELECT * FROM ordersfilled WHERE want='BTC' and processed='1' ORDER BY rate DESC";
...
if($count!=0) {
   echo '<table>
            <tr>
               ...
               <td align="left" style="font-weight: bold; padding: 2px; padding-left: 10px;" nowrap>Amount (BTE)</td>
   ...
   $Query = mysql_query("SELECT date, action, amount, rate, total FROM ordersfilled WHERE want='BTC' and processed='1' ORDER BY id DESC");
