...
if($count!=0) {
   $Query = mysql_query("SELECT amount, rate FROM sell_orderbook WHERE want='BTC' and processed='1' ORDER BY rate ASC");
   while($Row = mysql_fetch_assoc($Query)) {
      ...
      echo '<table>
               <tr>
                  ...
                  <td colspan="3" align="right" style="padding: 2px;" nowrap>Total BTE: '.$cncvalue.'</td>
               </tr><tr>
