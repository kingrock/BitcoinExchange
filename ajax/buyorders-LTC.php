...
$sql = "SELECT * FROM buy_orderbook WHERE want='LTC' and processed='1'";
$result = mysql_query($sql);
$count = mysql_num_rows($result);
if($count!=0) {
   $Query = mysql_query("SELECT action, amount, rate FROM buy_orderbook WHERE want='LTC' and processed='1' ORDER BY rate DESC");
   ...
   echo '<table>
         <tr>
            <td colspan="4" align="left" style="font-weight: bold; padding: 2px;" nowrap>Buy Orders</td>
         </tr><tr>
                  <td colspan="4" align="right" style="padding: 2px;" nowrap>Total BTE: '.$cncvalue.'</td>
               </tr><tr>
